class Item < ApplicationRecord
  ...
  with_options presence: true do
    ...
    validates :name
    validates :text
    validates :money,            format: { with: /\A[0-9]+\z/,message: "Half-width number"},numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9_000_000, message: "Out of setting range" }
